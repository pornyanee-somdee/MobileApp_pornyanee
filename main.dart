              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    Flexible(child: Row(children: [myButton("4"), myButton("5"), myButton("6"), myButton("x")])),
                    Flexible(child: Row(children: [myButton("1"), myButton("2"), myButton("3"), myButton("-")])),
                    Flexible(child: Row(children: [myButton("C"), myButton("0"), myButton("="), myButton("+")])),
                  ],
                ),
              ),
            ],
